...
function Wishlist() {
  ...
  return (
    <div className="wishlist">
      <p style={{ fontSize: "40px", fontWeight: "600", position: "relative" }}>
        Избранные товары<sup className="likesup wishsup">{wish.length}</sup>
      </p>
      <ul className="lists wishlists">{wishes}</ul>
    </div>
  );
}
