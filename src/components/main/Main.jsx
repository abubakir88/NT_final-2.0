  ...
  let categories = category?.map((item) => (
    <div className="category" key={item.id}>
      <div>
        <h4>{item.title}</h4>
        <p>
          От {item.price}₽ <IoIosArrowRoundForward size={20} />
        </p>
      </div>
    ...
    <main className="main">
      <section className="catalogsection">
        <div className="sectiontitle">
          ...
          <button className="arrowbtn">
            Весь каталог <IoIosArrowRoundForward size={20} />
          </button>
        </div>
      ...
      <section className="siteabout">
        <div className="sectiontitle">
          ...
          <button className="arrowbtn" onClick={() => navigate("/about")}>
            О компании <IoIosArrowRoundForward size={20} />
          </button>
        </div>
      ...
      <section className="productsection">
        <div className="sectiontitle">
          ...
          <button className="arrowbtn" onClick={() => navigate("/allproducts")}>
            Все товары <IoIosArrowRoundForward size={20} />
          </button>
        </div>
      ...
      <section className="blogsection">
        <div className="sectiontitle">
          <h3>Блог</h3>
          <button className="arrowbtn">
            Перейти в блог <IoIosArrowRoundForward size={20} />
          </button>
        </div>
        <div className="homes">
          <div className="home">
