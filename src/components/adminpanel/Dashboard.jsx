    ...
    <div className="dashboard">
      <div className="controlpanel">
        <div className="controlls">
          ...
          >
            <TbCategoryPlus color="white" size={25} /> Create product
          </button>
          <button
            onClick={() => {
          ...
          >
            <CiEdit color="white" size={25} /> Manage product
          </button>
          <button
            onClick={() => {
              setCreateproduct(false);
          ...
          >
            <TbCategoryPlus color="white" size={25} /> Create category
          </button>
          <button
            onClick={() => {
              setCreateproduct(false);
          ...
          >
            <CiEdit color="white" size={25} /> Manage category
          </button>
        </div>
        <button
          onClick={() => {
      ...
      {manageproduct ? (
        <Manageproduct product={product} category={category} />
      ) : (
        <></>
      )}
      {createcategory ? (
